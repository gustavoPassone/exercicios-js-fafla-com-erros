...
const btns = [
  ...
  },
  {
    ...
    func: () => {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        if (nome.toLowerCase().includes("a")) nomes.push(nome);
      }
...

  {
    ...
    func: () => {
      ...
      const vogais = texto.toLowerCase().match(/[aeiou]/g);
      alert(vogais ? `Quantidade de vogais: ${vogais.length}` : "Nenhuma vogal")
    },
  },
  {
  ...
  },
  {
    ...
    func: () => {
      ...
      alert(`Média: ${(soma / cont).toFixed(2)}`);
    },
  },
  {
  ...
  },
  {
    ...
    func: () => {
      let soma = 0;
      for (let i = 1; i <= 10; i++) {
        const num = Number(prompt(`${i}° número:`));
        if (num % 2 == 0) soma += num;
      }
  ...
  },
  {
    ...
    func: () => {
      let soma = 0;
      for (let i = 1; i <= 5; i++) soma += Number(prompt(`${i}° idade:`));
  ...
  },
  {
    ...
    func: () => {
      ...
      alert(`Número de palavras: ${frase.length}`);
    },
  },
  {
    nome: "Ex. 36 - Notas >= 7",
    func: () => {
      ...
      alert(count > 0 ?`${count} notas são maiores ou iguais a 7` : "Nenhuma nota é maior que 7");
    },
  },
  {
